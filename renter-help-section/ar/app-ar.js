...
// ===== SEARCH AUTOCOMPLETE =====
const searchData = [
  { text: 'كيفية إنشاء حساب', url: 'for-renters.html#getting-started' },
  { text: 'التحقق من الهوية', url: 'for-renters.html#identity' },
  { text: 'إجراء حجز', url: 'for-renters.html#booking' },
  { text: 'طرق الدفع', url: 'for-renters.html#payments' },
  { text: 'سياسات الإلغاء', url: 'for-renters.html#cancellations' },
  { text: 'مدة الاسترداد', url: 'for-renters.html#cancellations' },
  { text: 'إنشاء إعلان', url: 'for-owners.html#listings' },
  { text: 'استراتيجيات التسعير', url: 'for-owners.html#listings' },
  { text: 'إدارة الحجوزات', url: 'for-owners.html#bookings' },
  { text: 'المدفوعات والأرباح', url: 'for-owners.html#earnings' },
  { text: 'التأمينات', url: 'for-owners.html#protection' },
  { text: 'مطالبات الأضرار', url: 'for-owners.html#protection' },
  { text: 'متطلبات تأجير السيارات', url: 'for-renters.html#cars' },
  { text: 'دليل تأجير العقارات', url: 'for-renters.html#properties' },
