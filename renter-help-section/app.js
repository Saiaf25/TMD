...
// ===== SEARCH AUTOCOMPLETE =====
const searchData = [
  { text: 'How to create an account', url: 'for-renters.html#getting-started' },
  { text: 'Identity verification', url: 'for-renters.html#identity' },
  { text: 'Making a booking', url: 'for-renters.html#booking' },
  { text: 'Payment methods', url: 'for-renters.html#payments' },
  { text: 'Cancellation policies', url: 'for-renters.html#cancellations' },
  { text: 'Refund timeline', url: 'for-renters.html#cancellations' },
  { text: 'Creating a listing', url: 'for-owners.html#listings' },
  { text: 'Pricing strategies', url: 'for-owners.html#listings' },
  { text: 'Managing bookings', url: 'for-owners.html#bookings' },
  { text: 'Payments & earnings', url: 'for-owners.html#earnings' },
  { text: 'Security deposits', url: 'for-owners.html#protection' },
  { text: 'Damage claims', url: 'for-owners.html#protection' },
  { text: 'Car rental requirements', url: 'for-renters.html#cars' },
  { text: 'Property rental guide', url: 'for-renters.html#properties' },
